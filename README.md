...
[![License: MIT](https://img.shields.io/github/license/fuse-open/types.svg?style=flat-square)](LICENSE.txt)
...
TypeScript definitions for FuseJS modules. The source code is located in [Fuselibs](https://github.com/fuse-open/fuselibs).
...
Please report issues [here](https://github.com/fuse-open/types/issues).
